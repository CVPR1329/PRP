...
class PredictDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        recon_inds = torch.arange(0,len(videodata),step=int(sample_step/recon_rate))
...
#         motion_mask_list = []
        for i in range(sample_step):
            ...
            max_patch_x,max_patch_y,patch_loss_mask = patch_region.getPatchLossMask_stepsize(clip16,recon_clip_mask,low=0.8,high=2.0)
...
#         motion_mask = torch.cat(motion_mask_list,dim=1)
        ...
        return sample_clip,recon_clip,sample_step_label,recon_rate,patch_loss_mask
